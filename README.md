...
|------|:-------|:-------|
|* [x] Dnc.Core|核心类库|
|* [x] Dnc.Dispatcher|调度插件,基于Quartz.net实现|
|* [x] Dnc.Data|EntityFrameworkCore扩展|
|* [x] Dnc.Redis|redis插件，基于csredis实现|
|* [x] Dnc.SeedWork|DDD基础设施库|
|* [x] Dnc.Events|事件驱动实现接口定义|
|* [x] Dnc.Events.InMemory|事件驱动内存级别实现包含事件总线和事件存储（文本存储json格式）|
|* [x] Dnc.Events.RabbitMQ|事件驱动,事件总线rabbitmq实现|
|* [x] Dnc.Events.MySql|事件驱动，事件存储mysql实现|
|* [x] Dnc.CQRS|CQRS简单实现基于注入容器|
|* [x] Dnc.Aspects|AOP插件|
